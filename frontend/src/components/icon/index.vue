...
const icons = {
  ...
  frontend: {
    paths: [
      ...
      'M3 9h18',
      'M6.5 6.2a0.8 0.8 0 1 1 0 1.6a0.8 0.8 0 1 1 0-1.6z',
      'M9 6.2a0.8 0.8 0 1 1 0 1.6a0.8 0.8 0 1 1 0-1.6z',
      'M11.5 6.2a0.8 0.8 0 1 1 0 1.6a0.8 0.8 0 1 1 0-1.6z',
      'M10 12.5l-2.5 2.5 2.5 2.5',
      'M14 12.5l2.5 2.5-2.5 2.5',
      'M12.5 11.5l-1 7',
    ],
  },
  // AI:星芒(Sparkles)
  ai: {
    paths: [
      'M11 5l1.8 3.2L16 10l-3.2 1.8L11 15l-1.8-3.2L6 10l3.2-1.8L11 5z',
      'M17.5 13l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2z',
    ],
  },
  // 后端:三层服务器
  backend: {
    paths: [
      'M5 4h14a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z',
      'M5 9.5h14a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1z',
      'M5 15h14a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1z',
      'M6.4 6.5a0.6 0.6 0 1 0 1.2 0a0.6 0.6 0 1 0-1.2 0',
      'M6.4 12a0.6 0.6 0 1 0 1.2 0a0.6 0.6 0 1 0-1.2 0',
      'M6.4 17.5a0.6 0.6 0 1 0 1.2 0a0.6 0.6 0 1 0-1.2 0',
      'M10 6.5h5',
      'M10 12h5',
      'M10 17.5h5',
    ],
  ...
  engineering: {
    paths: [
      'M21 12l-2.53-2.68-.11-3.68-3.68-.11L12 3 9.32 5.53l-3.68.11-.11 3.68L3 12l2.53 2.68.11 3.68 3.68.11L12 21l2.68-2.53 3.68-.11.11-3.68L21 12z',
  ...
  notes: {
    paths: [
      'M5 3h11l3 3v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z',
      'M16 3v3h3',
      'M8 10h7',
      'M8 13h7',
      'M8 16h5',
