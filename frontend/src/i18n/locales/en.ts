export default {
  ...
  home: {
    ...
    about: {
      title: 'ABOUT',
      description: 'A little about me and what I\'m building.',
      name: 'LESLIE ZHAO',
      role: 'Frontend Engineer · Builder · Explorer',
      bio1: 'I build modern web applications, developer tools, and experiments at the intersection of frontend engineering and AI.',
      bio2: 'This blog is where I document what I learn, what I build, and the ideas I\'m currently exploring.',
      currentlyTitle: 'CURRENTLY',
      building: 'Building',
      buildingDesc: 'Developer tools & personal projects',
      exploring: 'Exploring',
      exploringDesc: 'AI Agents, LLMs & AI-assisted development',
      writing: 'Writing',
      writingDesc: 'Frontend engineering & architecture',
